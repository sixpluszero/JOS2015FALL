...
.Ltext0:
	...
	.stabs	"void:t(0,17)=(0,17)",128,0,0,0
...
.LHOTB2:
	.align 4
	.stabs	"test_backtrace:F(0,17)",36,0,0,test_backtrace
...
.LHOTB4:
	.align 4
	.stabs	"i386_init:F(0,17)",36,0,0,i386_init
	.globl	i386_init
...
.LHOTB7:
	.align 4
	.stabs	"_panic:F(0,17)",36,0,0,_panic
	.stabs	"file:p(0,18)=*(0,2)",160,0,0,16
	.stabs	"line:p(0,1)",160,0,0,20
	.stabs	"fmt:p(0,18)",160,0,0,24
	.globl	_panic
...
.LHOTB9:
	.align 4
	.stabs	"_warn:F(0,17)",36,0,0,_warn
	.stabs	"file:p(0,18)",160,0,0,16
	.stabs	"line:p(0,1)",160,0,0,20
	.stabs	"fmt:p(0,18)",160,0,0,24
	.globl	_warn
	.type	_warn, @function
...
.Lscope4:
	.comm	panicstr,4,4
	.stabs	"panicstr:G(0,18)",32,0,0,0
